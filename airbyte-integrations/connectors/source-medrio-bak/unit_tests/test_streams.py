...
import pytest
from source_medrio.streams import MedrioHttpStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MedrioHttpStream, "path", "v0/example_endpoint")
    mocker.patch.object(MedrioHttpStream, "primary_key", "test_primary_key")
    mocker.patch.object(MedrioHttpStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MedrioHttpStream()
